...
这里尝试将ceph部署到kubernetes上，主要使用statefulset来部署ceph-mon，daemonset来部署ceph-osd，在部署的时候会考虑k8s对应的psp权限，使用的镜像为[ceph/daemon](https://hub.docker.com/r/ceph/daemon/)
